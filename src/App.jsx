...
const isRimProt=isBig&&((p.blk>2.5&&p.reb>11)||(p.blk>3.2&&p.reb>9));
...
const isScoringGuard=isGuard&&p.pts>22&&p.ast>=4;
const isSpotUp=p.tR>0.45&&p.tpPct>37&&p.pts<26&&(p.stl>1.0||p.reb>3);
const isMidrange=(isBig||isWing)&&p.pts>18&&p.tR<0.22&&p.fg>47;
const isGlass=isBig&&p.reb>12&&p.blk<2.0&&p.pts<22&&p.fg>52;
